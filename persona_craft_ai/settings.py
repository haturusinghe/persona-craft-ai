...
class Settings(BaseSettings):
    ...
    COMET_PROJECT: str = "persona_craft_ai"

    # --- Required settings when deploying the code. ---
    # --- Otherwise, default values values work fine. ---

    # MongoDB database
    DATABASE_HOST: str = "mongodb://persona_craft_ai:persona_craft_ai@127.0.0.1:27017"
    DATABASE_NAME: str = "persona_craft_ai"
    ...
    # AWS SageMaker
    HF_MODEL_ID: str = "haturusinghe/PersonaCraftAILlama-3.1-8B-DPO"
    ...
    SAGEMAKER_ENDPOINT_CONFIG_INFERENCE: str = "persona_craft_ai"
    SAGEMAKER_ENDPOINT_INFERENCE: str = "persona_craft_ai"
