...
def finetune(
    ...
    if finetuning_type == "sft":
        ...
        dataset1 = load_dataset(f"{dataset_huggingface_workspace}/personacraft_ai", split="train")
        dataset2 = load_dataset("haturusinghe/FineTome-Alpaca-100k", split="train[:10000]")
        ...
        dataset = load_dataset(f"{dataset_huggingface_workspace}/personacraft_ai-dpo", split="train")
        if is_dummy:
            try:
                dataset = dataset.select(range(400))
            except Exception:
...
def check_if_huggingface_model_exists(model_id: str, default_value: str = "haturusinghe/PersonaCraftAILlama-3.1-8B") -> str:
    api = HfApi()
    ...
    try:
        ...
        print("Train your own 'PersonaCraftAILlama-3.1-8B' to avoid this behavior.")  # noqa
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_huggingface_workspace", type=str, default="haturusinghe")
    parser.add_argument("--model_output_huggingface_workspace", type=str, default="haturusinghe")
    ...
    if args.finetuning_type == "sft":
        ...
        sft_output_model_repo_id = f"{args.model_output_huggingface_workspace}/PersonaCraftAILlama-3.1-8B"
        ...
        sft_base_model_repo_id = f"{args.model_output_huggingface_workspace}/PersonaCraftAILlama-3.1-8B"
        ...
        dpo_output_model_repo_id = f"{args.model_output_huggingface_workspace}/PersonaCraftAILlama-3.1-8B-DPO"
